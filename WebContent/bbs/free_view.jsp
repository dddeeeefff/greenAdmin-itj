...
.answer_text:nth-child(1) { margin-top: 10px; }
...
%>
				<div class="answer">
					...
					<div class="reply-content">
						...
						<p class="answer_text"><%=bfr.getBfr_date().substring(0, 10) %>
						<input type="button" value="댓글 삭제" onclick="replyDel(<%=bfr.getBfr_idx() %>);" /></p>
					</div>
				</div>
<% 	}
} else {
