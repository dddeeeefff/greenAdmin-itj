...
@WebServlet("/event_proc_in")
@MultipartConfig(
	fileSizeThreshold = 0, 
	maxFileSize = 1024 * 1024 * 5,		// 5MB 용량 제한
	//location = "E:/lmw/web/work/greenAdmin/WebContent/bbs/upload"
	location = "../../../../webapps/greenAdmin/bbs/upload"
)
public class EventProcInCtrl extends HttpServlet {
	private static final long serialVersionUID = 1L;
    public EventProcInCtrl() { super(); }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		EventProcInSvc eventProcInSvc = new EventProcInSvc();
		// System.out.println(be.getBe_img());
		request.setAttribute("be", be);
		
		int idx = eventProcInSvc.getNextIdx();
		
		int result = eventProcInSvc.eventProcIn(be);
